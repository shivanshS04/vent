...
This is an [Expo](https://expo.dev) project with Clerk authentication.
...
5. Create a `.env.local` file in the root directory:
   ...
   ```
6. Make sure `.env.local` is in your `.gitignore` file
...
- **Authentication**: Login with Google using Clerk
